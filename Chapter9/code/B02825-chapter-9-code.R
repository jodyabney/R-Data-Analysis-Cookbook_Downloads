#1. Exploiting vectorized operations
...
#2. Processing entire rows and columns as a whole using the apply function
...
#3. Applying a function to elements of a collection with lapply and sapply
...
#4. Applying functions to subsets of a vector
...
#5. Using the split-apply-combine strategy with plyr
...
#6. Slicing, dicing and combining data with data tables
